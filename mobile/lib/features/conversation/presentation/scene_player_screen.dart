...
class _ScenePlayerScreenState extends ConsumerState<ScenePlayerScreen> {
  ...
  Future<void> _open() async {
    try {
      ...
      await _best(() => controller.setBackgroundColor(const Color(0xFF0E1119)));
      await _best(() => controller.setNavigationDelegate(
        NavigationDelegate(
          onPageFinished: (_) {
  ...
  /// Runs a platform call that some implementations do not provide.
  Future<void> _best(Future<void> Function() call) async {
    try {
      await call();
